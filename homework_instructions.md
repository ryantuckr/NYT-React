...
In this activity, you'll create a new React-based rendition of the New York Times Article Search application (remember the [class activity from week 6](https://github.com/UCF-Coding-Boot-Camp/10-17-2017-VW-Class-Repository-FSF/tree/b56ff029481ebe6716bf854a027adabb66ec4010/06-ajax/Activities/16-NYTSearch )?). This assignment requires you to create React components, work with helper/util functions, and utilize the React mounting lifecycle to query and display articles based on user searches. You'll also use Node, Express and MongoDB so that users can save articles to read later.
